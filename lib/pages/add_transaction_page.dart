...
class _AddTransactionPageState extends State<AddTransactionPage> {
  ...
  Future<void> _loadTransactionData() async {
    ...
    try {
      final DocumentSnapshot transactionSnapshot =
  ...
  Future<void> _fetchProductInfo(String productNumber) async {
    ...
    try {
      ...
      if (productSnapshot.docs.isNotEmpty) {
        ...
        _showErrorMessage(
          "Product not found. Please check the product number.",
        );
      }
    } catch (e) {
  ...
  Future<bool> _isTransactionNumberUnique(String transactionNumber) async {
    ...
    try {
      final QuerySnapshot existingTransactions =
          await FirebaseFirestore.instance
              .collection("transactions")
  ...
  Future<void> _saveTransaction() async {
    ...
    try {
      ...
      if (!isUnique) {
        _showErrorMessage(
          "Transaction number already exists. Please use a different one.",
        );
        setState(() => isLoading = false);
        return;
      }
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                  onPressed:
                      () => _fetchProductInfo(
                        productNumberController.text.trim(),
                      ),
                            ...
                            child: Column(
                              children: [
                                TextFormField(
                                  ...
                                  readOnly:
                                      !isNewTransaction, // Only editable for new transactions
                                  validator: (value) {
                                ...
                                showDialog(
                                  ...
                                  builder:
                                      (context) => AlertDialog(
                                        ...
                                        content: const Text(
                                          'Are you sure you want to delete this transaction? This will restore all products to inventory.',
                                        ),
                                        actions: [
                                          TextButton(
                                            onPressed:
